<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-6"> <!-- Hier pb-6 toegevoegd -->
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Uitleenmarkt Link -->
                    <x-nav-link :href="route('uitleenmarkt')" :active="request()->routeIs('uitleenmarkt')">
                        {{ __('Uitleenmarkt') }}
                    </x-nav-link>

                    <!-- Leen Jouw Producten Link -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('uitleenmarkt')" :active="request()->routeIs('uitleenmarkt')">
                {{ __('Uitleenmarkt') }}
            </x-responsive-nav-link>
